...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "stock.controller.Facebook": [],
  "stock.controller.Google": [],
  "stock.controller.Main": [],
  "stock.form.Car": [],
  "stock.form.Course": [],
  "stock.form.Parametres": [],
  "stock.form.Profil": [],
  "stock.form.Registration": [],
  "stock.model.Car": [],
  "stock.model.Course": [],
  "stock.model.Valet": [],
  "stock.store.Cars": [],
  "stock.store.Courses": [],
  "stock.store.OpenCourses": [],
  "stock.store.Valets": [],
  "stock.utils.AutoComplete": [],
  "stock.utils.Config": [],
  "stock.utils.DataViewYpm": [],
  ...
  "stock.view.CarAdd": [],
  "stock.view.CarList": [],
  "stock.view.CourseCommentaire": [],
  "stock.view.FicheValet": [],
  "stock.view.Historique": [],
  "stock.view.Login": [],
  "stock.view.Main": [],
  "stock.view.Parametres": [],
  "stock.view.Qrcode": [],
  "stock.view.Validated": [],
  "stock.view.Waiting": []
});
