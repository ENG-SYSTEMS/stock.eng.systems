...
Ext.application({
    ...
    views: [
        'Main','Login','Qrcode','Waiting','CarList', 'Validated', 'Historique', 'CourseCommentaire'
    ],
    ...
    models: ['Valet','Course','Car'],
    
    stores: ['Valets','Courses','Cars', 'OpenCourses'],
        ...
        if (key&&user_id) {
            ...
            Ext.Ajax.request({
                ...
                success: function (response, opts) {
                    ...
                    if (obj.success) {
                        stock.utils.Config.setCurrentKey(key);
    ...
    listeners: {
        ...
        onLoginSuccess: function () {
           ...
           /* var lv = Ext.getStore('LocalVars');
            ...
            var courses = Ext.getStore('Courses');
            courses.getProxy().setExtraParams({
            ...
            //redefinition du store OPENCOURSE
            var opencourses = Ext.getStore('OpenCourses');
            opencourses.getProxy().setExtraParams({
                user_id: stock.utils.Config.getCurrentUser().user_id,
                logkey: stock.utils.Config.getCurrentKey()
            });
